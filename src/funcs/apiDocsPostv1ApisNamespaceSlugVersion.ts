 ...
 */
export function apiDocsPostv1ApisNamespaceSlugVersion(
  client: ScalarCore,
  request: operations.Postv1ApisNamespaceSlugVersionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1ApisNamespaceSlugVersionResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1ApisNamespaceSlugVersionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "postv1ApisNamespaceSlugVersion",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.Postv1ApisNamespaceSlugVersionResponseBody$inboundSchema,
    ),
