 ...
 */
export function schemasGetv1SchemasNamespaceSlugVersionSemver(
  client: ScalarCore,
  request: operations.Getv1SchemasNamespaceSlugVersionSemverRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Getv1SchemasNamespaceSlugVersionSemverResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Getv1SchemasNamespaceSlugVersionSemverRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "getv1SchemasNamespaceSlugVersionSemver",
    oAuth2Scopes: [],
