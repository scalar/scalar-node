 ...
 */
export function rulesGetv1RulesetsNamespace(
  client: ScalarCore,
  request: operations.Getv1RulesetsNamespaceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.Getv1RulesetsNamespaceResponseBody>,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Getv1RulesetsNamespaceRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getv1RulesetsNamespace",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      z.array(operations.Getv1RulesetsNamespaceResponseBody$inboundSchema),
    ),
