 ...
 */
export function scalarDocsPostv1GuidesSlugPublish(
  client: ScalarCore,
  request: operations.Postv1GuidesSlugPublishRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1GuidesSlugPublishResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1GuidesSlugPublishRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postv1GuidesSlugPublish",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Postv1GuidesSlugPublishResponseBody$inboundSchema),
