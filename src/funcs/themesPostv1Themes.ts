 ...
 */
export function themesPostv1Themes(
  client: ScalarCore,
  request: operations.Postv1ThemesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1ThemesResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.Postv1ThemesRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.Postv1ThemesResponseBody$inboundSchema),
