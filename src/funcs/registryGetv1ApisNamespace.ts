 ...
 */
export function registryGetv1ApisNamespace(
  client: ScalarCore,
  request: operations.Getv1ApisNamespaceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.ApiDocument>,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.Getv1ApisNamespaceRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getv1ApisNamespace",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(components.ApiDocument$inboundSchema)),
