...
export function loginPortalsGetv1LoginPortalsSlug(
  ...
  Result<
    operations.Getv1LoginPortalsSlugResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Getv1LoginPortalsSlugRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getv1LoginPortalsSlug",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Getv1LoginPortalsSlugResponseBody$inboundSchema),
