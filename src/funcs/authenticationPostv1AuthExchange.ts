 ...
 */
export function authenticationPostv1AuthExchange(
  client: ScalarCore,
  request: operations.Postv1AuthExchangeRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1AuthExchangeResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1AuthExchangeRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postv1AuthExchange",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Postv1AuthExchangeResponseBody$inboundSchema),
