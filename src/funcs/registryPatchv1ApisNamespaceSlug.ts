 ...
 */
export function registryPatchv1ApisNamespaceSlug(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Patchv1ApisNamespaceSlugRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "patchv1ApisNamespaceSlug",
    oAuth2Scopes: [],
