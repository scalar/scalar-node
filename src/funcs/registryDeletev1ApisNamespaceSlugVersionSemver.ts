 ...
 */
export function registryDeletev1ApisNamespaceSlugVersionSemver(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Deletev1ApisNamespaceSlugVersionSemverRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "deletev1ApisNamespaceSlugVersionSemver",
    oAuth2Scopes: [],
