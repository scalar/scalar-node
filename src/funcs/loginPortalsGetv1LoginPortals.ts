 ...
 */
export function loginPortalsGetv1LoginPortals(
  client: ScalarCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.Getv1LoginPortalsResponseBody>,
    | errors.FourHundred
...
> {
  ...
  >(
    M.json(
      200,
      z.array(operations.Getv1LoginPortalsResponseBody$inboundSchema),
    ),
