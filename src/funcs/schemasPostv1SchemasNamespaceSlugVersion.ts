 ...
 * Create a shared component version
 */
export function schemasPostv1SchemasNamespaceSlugVersion(
  client: ScalarCore,
  request: operations.Postv1SchemasNamespaceSlugVersionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1SchemasNamespaceSlugVersionResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1SchemasNamespaceSlugVersionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "postv1SchemasNamespaceSlugVersion",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.Postv1SchemasNamespaceSlugVersionResponseBody$inboundSchema,
    ),
