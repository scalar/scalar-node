 ...
 */
export function loginPortalsPostv1LoginPortals(
  client: ScalarCore,
  request: operations.Postv1LoginPortalsRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1LoginPortalsResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1LoginPortalsRequestBody$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postv1LoginPortals",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Postv1LoginPortalsResponseBody$inboundSchema),
