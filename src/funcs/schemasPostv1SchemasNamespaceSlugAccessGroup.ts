 ...
 */
export function schemasPostv1SchemasNamespaceSlugAccessGroup(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1SchemasNamespaceSlugAccessGroupRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "postv1SchemasNamespaceSlugAccessGroup",
    oAuth2Scopes: [],
