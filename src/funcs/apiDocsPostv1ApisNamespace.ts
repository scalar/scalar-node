 ...
 */
export function apiDocsPostv1ApisNamespace(
  client: ScalarCore,
  request: operations.Postv1ApisNamespaceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1ApisNamespaceResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1ApisNamespaceRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postv1ApisNamespace",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.Postv1ApisNamespaceResponseBody$inboundSchema),
