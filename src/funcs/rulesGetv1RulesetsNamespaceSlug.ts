 ...
 */
export function rulesGetv1RulesetsNamespaceSlug(
  client: ScalarCore,
  request: operations.Getv1RulesetsNamespaceSlugRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Getv1RulesetsNamespaceSlugResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Getv1RulesetsNamespaceSlugRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getv1RulesetsNamespaceSlug",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      operations.Getv1RulesetsNamespaceSlugResponseBody$inboundSchema,
    ),
