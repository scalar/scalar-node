 ...
 */
export function schemasPostv1SchemasNamespace(
  client: ScalarCore,
  request: operations.Postv1SchemasNamespaceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1SchemasNamespaceResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1SchemasNamespaceRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "postv1SchemasNamespace",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.Postv1SchemasNamespaceResponseBody$inboundSchema),
