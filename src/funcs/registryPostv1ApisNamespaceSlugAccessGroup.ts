 ...
 */
export function registryPostv1ApisNamespaceSlugAccessGroup(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Postv1ApisNamespaceSlugAccessGroupRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "postv1ApisNamespaceSlugAccessGroup",
    oAuth2Scopes: [],
