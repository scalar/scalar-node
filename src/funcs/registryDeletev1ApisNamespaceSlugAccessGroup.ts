 ...
 */
export function registryDeletev1ApisNamespaceSlugAccessGroup(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Deletev1ApisNamespaceSlugAccessGroupRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "deletev1ApisNamespaceSlugAccessGroup",
    oAuth2Scopes: [],
