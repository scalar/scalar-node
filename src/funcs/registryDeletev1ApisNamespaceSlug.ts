 ...
 */
export function registryDeletev1ApisNamespaceSlug(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Deletev1ApisNamespaceSlugRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deletev1ApisNamespaceSlug",
    oAuth2Scopes: [],
