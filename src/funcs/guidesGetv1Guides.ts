 ...
 */
export function guidesGetv1Guides(
  client: ScalarCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.Getv1GuidesResponseBody>,
    | errors.FourHundred
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.Getv1GuidesResponseBody$inboundSchema)),
