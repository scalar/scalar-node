 ...
 */
export function registryGetv1ApisNamespaceSlugVersionSemver(
  client: ScalarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.Getv1ApisNamespaceSlugVersionSemverRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    operationID: "getv1ApisNamespaceSlugVersionSemver",
    oAuth2Scopes: [],
