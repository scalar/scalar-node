 ...
 */
export function scalarDocsPostv1Guides(
  client: ScalarCore,
  request: operations.Postv1GuidesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.Postv1GuidesResponseBody,
    | errors.FourHundred
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.Postv1GuidesRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.Postv1GuidesResponseBody$inboundSchema),
